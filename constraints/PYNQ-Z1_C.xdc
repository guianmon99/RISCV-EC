...
create_clock -add -name sys_clk_pin -period 16.667 -waveform {0 4} [get_ports { sys_clk }];
...
set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { out_test }]; #IO_L6N_T0_VREF_34 Sch=led[0]
...
create_clock -period 16.667 -name clk -waveform {0.000 8.334} [get_ports clk]
